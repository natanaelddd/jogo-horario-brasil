    ...
    return (
      <Card>
        <CardContent className="p-6">
          <p className="text-center">Carregando classificação...</p>
        </CardContent>
      </Card>
    );
  }
                ...
                <TableRow key={standing.id} className="hover:bg-muted/50">
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="font-semibold">{standing.posicao}</span>
                    </div>
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="font-medium text-sm">{standing.team.nome}</p>
                        <p className="text-xs text-muted-foreground">{standing.team.sigla}</p>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="text-center font-bold">{standing.pontos}</TableCell>
                  <TableCell className="text-center">{standing.jogos}</TableCell>
                  <TableCell className="text-center">{standing.vitorias}</TableCell>
                  <TableCell className="text-center">{standing.empates}</TableCell>
                  <TableCell className="text-center">{standing.derrotas}</TableCell>
                  <TableCell className="text-center">{standing.gols_pro}</TableCell>
                  <TableCell className="text-center">{standing.gols_contra}</TableCell>
                  <TableCell className="text-center font-medium">
                    <span className={standing.saldo_gols >= 0 ? 'text-green-600' : 'text-red-600'}>
                      {standing.saldo_gols > 0 ? '+' : ''}{standing.saldo_gols}
                    </span>
                  </TableCell>
                  <TableCell className="text-center">{standing.aproveitamento.toFixed(1)}%</TableCell>
